         ...
         <div class="center max-w-md w-full "> 
            <div class="p-1 bg-blue-600 rounded-lg mt-4">
                ...
                <div class="my-10 mt-2">
                    <form class="bg-white shadow-md rounded px-6 pt-4 pb-6 mb-2" method="POST" action="{{route('register')}}">
                        @csrf
                        ...
                        <div class="form-group row mb-0">
                            <div class="flex items-center justify-between mb-2">
                                <button class="py-2 px-10 w-full bg-red-600 text-white font-blod text-lg rounded-lg hover:bg-red-400" type="submit" class="btn btn-primary">
                                    {{ __('Créer un compte') }}
                                </button>
                            </div>
                            <div class="flex-col mt-2"> 
                              <a class="bg-green-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" href="{{route('login')}}"> Se connecter</a>
